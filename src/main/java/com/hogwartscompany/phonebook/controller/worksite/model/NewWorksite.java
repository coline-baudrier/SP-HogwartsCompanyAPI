package com.hogwartscompany.phonebook.controller.worksite.model;

public class NewWorksite {

    String nameWorksite;
    String typeWorksite;
    String phoneWorksite;
    String emailWorksite;
    int idAddress;
    ...
    public void setNameWorksite(String nameWorksite) {
        this.nameWorksite = nameWorksite;
    }
    ...
    public void setTypeWorksite(String typeWorksite) {
        this.typeWorksite = typeWorksite;
    }
    ...
    public void setPhoneWorksite(String phoneWorksite) {
        this.phoneWorksite = phoneWorksite;
    }
    ...
    public void setEmailWorksite(String emailWorksite) {
        this.emailWorksite = emailWorksite;
    }
